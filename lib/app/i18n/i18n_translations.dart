...
class I18nTranslations extends Translations {
  ...
  final Map<String, Map<String, String>> _keys = {
    'zh_CN': {
      ...
      I18n.browseSettingsPageTitle: '浏览设置',
      I18n.downloadSettingsPageTitle: '下载设置',
      I18n.translateSettingsPageTitle: '翻译设置',
      ...
      I18n.maxDownloadTaskCount: '最大下载任务数量 %s',
      I18n.useCustomImageSource: '使用自定义图片源',
      I18n.mediumImage: '中等',
      I18n.largeImage: '大图',
      I18n.originalImage: '原图',
      I18n.languageExpansion: '语言拓展包',
      I18n.clearLanguageExpansion: '清空语言拓展包',
      I18n.loadFromGitHub: '从GitHub加载',
      I18n.updateLanguageExpansionHint: '更新了%s个语言拓展包,将在重启APP后生效',
      I18n.noUpdateLanguageExpansionHint: '没有需要更新的语言拓展包',
    ...
    'en_US': {
      ...
      I18n.browseSettingsPageTitle: 'Browse Settings',
      I18n.downloadSettingsPageTitle: 'Download Settings',
      I18n.translateSettingsPageTitle: 'Translate Settings',
      ...
      I18n.maxDownloadTaskCount: 'Max download task count %s',
      ...
      I18n.loadFromGitHub: 'Load from GitHub',
      I18n.updateLanguageExpansionHint: 'Update %s language extension packs Restart app to activate',
      I18n.noUpdateLanguageExpansionHint: 'No language extension packs that need to be updated',
      ...
      I18n.bookmarkNovel: 'Bookmark Novel',
    ...
    'ja_JP': {
      ...
      I18n.browseSettingsPageTitle: 'ブラウズ設定',
      I18n.downloadSettingsPageTitle: 'ダウンロード設定',
      I18n.translateSettingsPageTitle: '翻訳設定',
      ...
      I18n.versionUpdate: '新しいバージョンへ更新',
      ...
      I18n.deleteThisHistory: '閲覧履歴を削除しますか?',
      ...
      I18n.maxDownloadTaskCount: '最大ダウンロード タスク数 %s',
      I18n.useCustomImageSource: 'オリジナルの画像ソースを使用する',
      I18n.mediumImage: '標準画質',
      I18n.largeImage: '高画質',
      I18n.originalImage: 'オリジナル画質',
      I18n.languageExpansion: '言語拡張パック',
      I18n.clearLanguageExpansion: '言語拡張パックをすべて削除',
      I18n.loadFromGitHub: 'GitHubから読み込む',
      I18n.updateLanguageExpansionHint: '%s個の言語拡張パックを更新 アプリを再起動して有効化',
      I18n.noUpdateLanguageExpansionHint: 'アップデートが必要な言語拡張パックはありません',
      ...
      I18n.introductionHint: '自己紹介を入力してください',
      I18n.updateProfile: 'プロフィールを更新',
      I18n.workspacePc: 'コンピュータ',
      I18n.workspaceMonitor: 'モニタ',
      I18n.workspaceTool: 'ソフト',
      I18n.workspaceScanner: 'スキャナ',
      I18n.workspaceTablet: 'タブレット',
      I18n.workspaceMouse: 'マウス',
      I18n.workspacePrinter: 'プリンタ',
    ...
    'ru_RU': {
      ...
      I18n.browseSettingsPageTitle: 'Настройки ',
      I18n.downloadSettingsPageTitle: 'Скачать настройки',
      I18n.translateSettingsPageTitle: 'Настройки перевода',
      ...
      I18n.imageSource: 'Источник изображений',
      ...
      I18n.maxDownloadTaskCount: 'максимальное количество задач загрузки %s',
      ...
      I18n.languageExpansion: 'Расширение языков',
      I18n.clearLanguageExpansion: 'Очистить список языков',
      I18n.updateLanguageExpansionHint: 'Обновление языковых расширений %s. Перезапустите приложение, чтобы активировать.',
      I18n.noUpdateLanguageExpansionHint: 'Нет языковых расширений, которые нужно обновлять',
